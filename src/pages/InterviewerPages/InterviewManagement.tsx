...
console.log("iiiiiiiiiiiprinting ", interviews);
  ...
  <table className="table table-hover align-middle text-center mb-0">
    <thead className="table-light">
      <tr>
        <th style={{ width: "25%", textAlign: "left", paddingLeft: "1.5rem" }}>
          Candidate
        </th>
      ...
      {filteredInterviews.map((interview) => (
        <tr key={interview.interviewId}>
          ...
          <td className="text-start ps-4">
            <div className="fw-semibold">{interview.applicantName}</div>
          ...
          <td>
            <span
              className={`badge px-3 py-2 ${getStatusBadgeColor(
